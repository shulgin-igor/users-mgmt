...
module.exports = class User {
    ...
    /**
     * Finds all users in DB and returns array of User objects with loaded fields
     * @returns Promise
     */
    static findAll() {
    ...
    create() {
        return hydra.makeAPIRequest(new Message(`db-service:[post]${BASE_URL}`, this.fields)).then(response => {
